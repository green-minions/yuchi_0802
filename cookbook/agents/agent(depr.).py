...
def get_agent(
    ...
    # Incuding: Calculator, web_search(ddg_search vs EXA search?), finance, file
    tools: List[Toolkit] = []
    ...
    # including: database, python, research(including exa, duckduckgo, database)
    team: List[Assistant] = []
    ...
    agent = Assistant(
        ...
        description=dedent(
            """\
        You are a powerful AI Agent called `阿星小幫手`.
