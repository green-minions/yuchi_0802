...
def main() -> None:
    ...
    # Get LLM Model
    llm_id = st.sidebar.selectbox("### 請選擇你要的LLM", options=["gpt-4o-mini","gpt-4o","gpt-4-turbo", "gemini-1.5-flash"]) or "gpt-4o-mini"
    # llm_id = st.sidebar.selectbox("### 請選擇你要的LLM", options=["gemini-1.5-flash"])
    ...
    # Load personalized_assistant knowledge base
    if personalized_assistant.knowledge_base:
        ...
        input_url = st.sidebar.text_input(
            "請增加 URL 到阿星的知識庫", type="default", key=st.session_state["url_scrape_key"]
        )
